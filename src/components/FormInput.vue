...
<template>
    ...
    <!--<span class="block relative">
        <input v-bind="{ ...$attrs, ...props, ...attributes }" v-model="value"
            class="peer px-3 py-2 border border-muted transition-all appearance-none rounded-md focus:outline-none focus:outline-offset-0 focus:ring-[3px] ring-primary-100 focus:border-primary-500 hover:border-primary-500">
        <label
